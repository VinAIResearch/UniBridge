...
for lang in aym bzd gn hch oto quy tar;
do
    python train_tgt_mlm.py --lang $lang --seed 42 --lr 5e-4 --mlm_epoch 50
done
for lang in cni nah shp;
do
    python train_tgt_mlm.py --lang $lang --seed 42 --lr 3e-4 --mlm_epoch 50
done

for lang in ar en ru zh ja;
do
    python train_src_mlm.py --lang $lang --seed 42 --lr 1e-3 --epoch 20
done

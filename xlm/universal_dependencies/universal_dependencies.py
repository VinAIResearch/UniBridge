...
_DESCRIPTIONS = {
    ...
    "lij_glt": "The Genoese Ligurian Treebank is a small, manually annotated collection of contemporary Ligurian prose. The focus of the treebank is written Genoese, the koiné variety of Ligurian which is associated with today's literary, journalistic and academic ligurophone sphere.",
    ...
    "mk_mtb": "The Macedonian-MTB treebank is a collection of annotated sentences based on the raw monolingual corpus called Macedonian Language Digital Resources (MLDR).",
    ...
    "sd_mazhardootio": "The Sindhi Universal Dependency Treebank was automatically converted from Sindhi Dependency Treebank (SDTB) which is part of an ongoing effort of creating multi-layered treebanks for Sindhi.",
    "si_stb": "This treebank consists contemporary written Sinhala text taken from a 10M corpus maintained by UCSC, Sri Lanka. The corpus contains novels, short stories, Sinhala translations, critiques and Sinhala newspapers.",
    ...
    "tt_nmctt": "UD Tatar-NMCTT is a manually annotated corpus of the Tatar language based on the text from Tatar-Inform (tatar-inform.tatar), an online news website.",
...
_UD_DATASETS = {
    "af_afribooms": {
        "train": "UD_Afrikaans-AfriBooms/r2.13/af_afribooms-ud-train.conllu",
        "dev": "UD_Afrikaans-AfriBooms/r2.13/af_afribooms-ud-dev.conllu",
        "test": "UD_Afrikaans-AfriBooms/r2.13/af_afribooms-ud-test.conllu",
    },
    "akk_pisandub": {
        "test": "UD_Akkadian-PISANDUB/r2.13/akk_pisandub-ud-test.conllu",
    },
    "akk_riao": {
        "test": "UD_Akkadian-RIAO/r2.13/akk_riao-ud-test.conllu",
    },
    "aqz_tudet": {
        "test": "UD_Akuntsu-TuDeT/r2.13/aqz_tudet-ud-test.conllu",
    },
    "sq_tsa": {
        "test": "UD_Albanian-TSA/r2.13/sq_tsa-ud-test.conllu",
    },
    "am_att": {
        "test": "UD_Amharic-ATT/r2.13/am_att-ud-test.conllu",
    },
    "grc_perseus": {
        "train": "UD_Ancient_Greek-Perseus/r2.13/grc_perseus-ud-train.conllu",
        "dev": "UD_Ancient_Greek-Perseus/r2.13/grc_perseus-ud-dev.conllu",
        "test": "UD_Ancient_Greek-Perseus/r2.13/grc_perseus-ud-test.conllu",
    },
    "grc_proiel": {
        "train": "UD_Ancient_Greek-PROIEL/r2.13/grc_proiel-ud-train.conllu",
        "dev": "UD_Ancient_Greek-PROIEL/r2.13/grc_proiel-ud-dev.conllu",
        "test": "UD_Ancient_Greek-PROIEL/r2.13/grc_proiel-ud-test.conllu",
    },
    "apu_ufpa": {
        "test": "UD_Apurina-UFPA/r2.13/apu_ufpa-ud-test.conllu",
    },
    "ar_nyuad": {
        "train": "UD_Arabic-NYUAD/r2.13/ar_nyuad-ud-train.conllu",
        "dev": "UD_Arabic-NYUAD/r2.13/ar_nyuad-ud-dev.conllu",
        "test": "UD_Arabic-NYUAD/r2.13/ar_nyuad-ud-test.conllu",
    },
    "ar_padt": {
        "train": "UD_Arabic-PADT/r2.13/ar_padt-ud-train.conllu",
        "dev": "UD_Arabic-PADT/r2.13/ar_padt-ud-dev.conllu",
        "test": "UD_Arabic-PADT/r2.13/ar_padt-ud-test.conllu",
    },
    "ar_pud": {
        "test": "UD_Arabic-PUD/r2.13/ar_pud-ud-test.conllu",
    },
    "hy_armtdp": {
        "train": "UD_Armenian-ArmTDP/r2.13/hy_armtdp-ud-train.conllu",
        "dev": "UD_Armenian-ArmTDP/r2.13/hy_armtdp-ud-dev.conllu",
        "test": "UD_Armenian-ArmTDP/r2.13/hy_armtdp-ud-test.conllu",
    },
    "aii_as": {
        "test": "UD_Assyrian-AS/r2.13/aii_as-ud-test.conllu",
    },
    "bm_crb": {
        "test": "UD_Bambara-CRB/r2.13/bm_crb-ud-test.conllu",
    },
    "eu_bdt": {
        "train": "UD_Basque-BDT/r2.13/eu_bdt-ud-train.conllu",
        "dev": "UD_Basque-BDT/r2.13/eu_bdt-ud-dev.conllu",
        "test": "UD_Basque-BDT/r2.13/eu_bdt-ud-test.conllu",
    },
    "be_hse": {
        "train": "UD_Belarusian-HSE/r2.13/be_hse-ud-train.conllu",
        "dev": "UD_Belarusian-HSE/r2.13/be_hse-ud-dev.conllu",
        "test": "UD_Belarusian-HSE/r2.13/be_hse-ud-test.conllu",
    },
    "bho_bhtb": {
        "test": "UD_Bhojpuri-BHTB/r2.13/bho_bhtb-ud-test.conllu",
    },
    "br_keb": {
        "test": "UD_Breton-KEB/r2.13/br_keb-ud-test.conllu",
    },
    "bg_btb": {
        "train": "UD_Bulgarian-BTB/r2.13/bg_btb-ud-train.conllu",
        "dev": "UD_Bulgarian-BTB/r2.13/bg_btb-ud-dev.conllu",
        "test": "UD_Bulgarian-BTB/r2.13/bg_btb-ud-test.conllu",
    },
    "bxr_bdt": {
        "train": "UD_Buryat-BDT/r2.13/bxr_bdt-ud-train.conllu",
        "test": "UD_Buryat-BDT/r2.13/bxr_bdt-ud-test.conllu",
    },
    "yue_hk": {
        "test": "UD_Cantonese-HK/r2.13/yue_hk-ud-test.conllu",
    },
    "ca_ancora": {
        "train": "UD_Catalan-AnCora/r2.13/ca_ancora-ud-train.conllu",
        "dev": "UD_Catalan-AnCora/r2.13/ca_ancora-ud-dev.conllu",
        "test": "UD_Catalan-AnCora/r2.13/ca_ancora-ud-test.conllu",
    },
    "zh_cfl": {
        "test": "UD_Chinese-CFL/r2.13/zh_cfl-ud-test.conllu",
    },
    "zh_gsd": {
        "train": "UD_Chinese-GSD/r2.13/zh_gsd-ud-train.conllu",
        "dev": "UD_Chinese-GSD/r2.13/zh_gsd-ud-dev.conllu",
        "test": "UD_Chinese-GSD/r2.13/zh_gsd-ud-test.conllu",
    },
    "zh_gsdsimp": {
        "train": "UD_Chinese-GSDSimp/r2.13/zh_gsdsimp-ud-train.conllu",
        "dev": "UD_Chinese-GSDSimp/r2.13/zh_gsdsimp-ud-dev.conllu",
        "test": "UD_Chinese-GSDSimp/r2.13/zh_gsdsimp-ud-test.conllu",
    },
    "zh_hk": {
        "test": "UD_Chinese-HK/r2.13/zh_hk-ud-test.conllu",
    },
    "zh_pud": {
        "test": "UD_Chinese-PUD/r2.13/zh_pud-ud-test.conllu",
    },
    "ckt_hse": {
        "test": "UD_Chukchi-HSE/r2.13/ckt_hse-ud-test.conllu",
    },
    "lzh_kyoto": {
        "train": "UD_Classical_Chinese-Kyoto/r2.13/lzh_kyoto-ud-train.conllu",
        "dev": "UD_Classical_Chinese-Kyoto/r2.13/lzh_kyoto-ud-dev.conllu",
        "test": "UD_Classical_Chinese-Kyoto/r2.13/lzh_kyoto-ud-test.conllu",
    },
    "cop_scriptorium": {
        "train": "UD_Coptic-Scriptorium/r2.13/cop_scriptorium-ud-train.conllu",
        "dev": "UD_Coptic-Scriptorium/r2.13/cop_scriptorium-ud-dev.conllu",
        "test": "UD_Coptic-Scriptorium/r2.13/cop_scriptorium-ud-test.conllu",
    },
    "hr_set": {
        "train": "UD_Croatian-SET/r2.13/hr_set-ud-train.conllu",
        "dev": "UD_Croatian-SET/r2.13/hr_set-ud-dev.conllu",
        "test": "UD_Croatian-SET/r2.13/hr_set-ud-test.conllu",
    },
    "cs_cac": {
        "train": "UD_Czech-CAC/r2.13/cs_cac-ud-train.conllu",
        "dev": "UD_Czech-CAC/r2.13/cs_cac-ud-dev.conllu",
        "test": "UD_Czech-CAC/r2.13/cs_cac-ud-test.conllu",
    },
    "cs_cltt": {
        "train": "UD_Czech-CLTT/r2.13/cs_cltt-ud-train.conllu",
        "dev": "UD_Czech-CLTT/r2.13/cs_cltt-ud-dev.conllu",
        "test": "UD_Czech-CLTT/r2.13/cs_cltt-ud-test.conllu",
    },
    "cs_fictree": {
        "train": "UD_Czech-FicTree/r2.13/cs_fictree-ud-train.conllu",
        "dev": "UD_Czech-FicTree/r2.13/cs_fictree-ud-dev.conllu",
        "test": "UD_Czech-FicTree/r2.13/cs_fictree-ud-test.conllu",
    },
    "cs_pdt": {
        "train": [
            "UD_Czech-PDT/r2.13/cs_pdt-ud-train-l.conllu",
            "UD_Czech-PDT/r2.13/cs_pdt-ud-train-m.conllu",
            "UD_Czech-PDT/r2.13/cs_pdt-ud-train-c.conllu",
            "UD_Czech-PDT/r2.13/cs_pdt-ud-train-v.conllu",
        ],
        "dev": "UD_Czech-PDT/r2.13/cs_pdt-ud-dev.conllu",
        "test": "UD_Czech-PDT/r2.13/cs_pdt-ud-test.conllu",
    },
    "cs_pud": {
        "test": "UD_Czech-PUD/r2.13/cs_pud-ud-test.conllu",
    },
    "da_ddt": {
        "train": "UD_Danish-DDT/r2.13/da_ddt-ud-train.conllu",
        "dev": "UD_Danish-DDT/r2.13/da_ddt-ud-dev.conllu",
        "test": "UD_Danish-DDT/r2.13/da_ddt-ud-test.conllu",
    },
    "nl_alpino": {
        "train": "UD_Dutch-Alpino/r2.13/nl_alpino-ud-train.conllu",
        "dev": "UD_Dutch-Alpino/r2.13/nl_alpino-ud-dev.conllu",
        "test": "UD_Dutch-Alpino/r2.13/nl_alpino-ud-test.conllu",
    },
    "nl_lassysmall": {
        "train": "UD_Dutch-LassySmall/r2.13/nl_lassysmall-ud-train.conllu",
        "dev": "UD_Dutch-LassySmall/r2.13/nl_lassysmall-ud-dev.conllu",
        "test": "UD_Dutch-LassySmall/r2.13/nl_lassysmall-ud-test.conllu",
    },
    "en_esl": {
        "train": "UD_English-ESL/r2.13/en_esl-ud-train.conllu",
        "dev": "UD_English-ESL/r2.13/en_esl-ud-dev.conllu",
        "test": "UD_English-ESL/r2.13/en_esl-ud-test.conllu",
    },
    "en_ewt": {
        "train": "UD_English-EWT/r2.13/en_ewt-ud-train.conllu",
        "dev": "UD_English-EWT/r2.13/en_ewt-ud-dev.conllu",
        "test": "UD_English-EWT/r2.13/en_ewt-ud-test.conllu",
    },
    "en_gum": {
        "train": "UD_English-GUM/r2.13/en_gum-ud-train.conllu",
        "dev": "UD_English-GUM/r2.13/en_gum-ud-dev.conllu",
        "test": "UD_English-GUM/r2.13/en_gum-ud-test.conllu",
    },
    "en_gumreddit": {
        "train": "UD_English-GUMReddit/r2.13/en_gumreddit-ud-train.conllu",
        "dev": "UD_English-GUMReddit/r2.13/en_gumreddit-ud-dev.conllu",
        "test": "UD_English-GUMReddit/r2.13/en_gumreddit-ud-test.conllu",
    },
    "en_lines": {
        "train": "UD_English-LinES/r2.13/en_lines-ud-train.conllu",
        "dev": "UD_English-LinES/r2.13/en_lines-ud-dev.conllu",
        "test": "UD_English-LinES/r2.13/en_lines-ud-test.conllu",
    },
    "en_partut": {
        "train": "UD_English-ParTUT/r2.13/en_partut-ud-train.conllu",
        "dev": "UD_English-ParTUT/r2.13/en_partut-ud-dev.conllu",
        "test": "UD_English-ParTUT/r2.13/en_partut-ud-test.conllu",
    },
    "en_pronouns": {
        "test": "UD_English-Pronouns/r2.13/en_pronouns-ud-test.conllu",
    },
    "en_pud": {
        "test": "UD_English-PUD/r2.13/en_pud-ud-test.conllu",
    },
    "myv_jr": {
        "test": "UD_Erzya-JR/r2.13/myv_jr-ud-test.conllu",
    },
    "et_edt": {
        "train": "UD_Estonian-EDT/r2.13/et_edt-ud-train.conllu",
        "dev": "UD_Estonian-EDT/r2.13/et_edt-ud-dev.conllu",
        "test": "UD_Estonian-EDT/r2.13/et_edt-ud-test.conllu",
    },
    "et_ewt": {
        "train": "UD_Estonian-EWT/r2.13/et_ewt-ud-train.conllu",
        "dev": "UD_Estonian-EWT/r2.13/et_ewt-ud-dev.conllu",
        "test": "UD_Estonian-EWT/r2.13/et_ewt-ud-test.conllu",
    },
    "fo_farpahc": {
        "train": "UD_Faroese-FarPaHC/r2.13/fo_farpahc-ud-train.conllu",
        "dev": "UD_Faroese-FarPaHC/r2.13/fo_farpahc-ud-dev.conllu",
        "test": "UD_Faroese-FarPaHC/r2.13/fo_farpahc-ud-test.conllu",
    },
    "fo_oft": {
        "test": "UD_Faroese-OFT/r2.13/fo_oft-ud-test.conllu",
    },
    "fi_ftb": {
        "train": "UD_Finnish-FTB/r2.13/fi_ftb-ud-train.conllu",
        "dev": "UD_Finnish-FTB/r2.13/fi_ftb-ud-dev.conllu",
        "test": "UD_Finnish-FTB/r2.13/fi_ftb-ud-test.conllu",
    },
    "fi_ood": {
        "test": "UD_Finnish-OOD/r2.13/fi_ood-ud-test.conllu",
    },
    "fi_pud": {
        "test": "UD_Finnish-PUD/r2.13/fi_pud-ud-test.conllu",
    },
    "fi_tdt": {
        "train": "UD_Finnish-TDT/r2.13/fi_tdt-ud-train.conllu",
        "dev": "UD_Finnish-TDT/r2.13/fi_tdt-ud-dev.conllu",
        "test": "UD_Finnish-TDT/r2.13/fi_tdt-ud-test.conllu",
    },
    "fr_fqb": {
        "test": "UD_French-FQB/r2.13/fr_fqb-ud-test.conllu",
    },
    "fr_ftb": {
        "train": "UD_French-FTB/r2.13/fr_ftb-ud-train.conllu",
        "dev": "UD_French-FTB/r2.13/fr_ftb-ud-dev.conllu",
        "test": "UD_French-FTB/r2.13/fr_ftb-ud-test.conllu",
    },
    "fr_gsd": {
        "train": "UD_French-GSD/r2.13/fr_gsd-ud-train.conllu",
        "dev": "UD_French-GSD/r2.13/fr_gsd-ud-dev.conllu",
        "test": "UD_French-GSD/r2.13/fr_gsd-ud-test.conllu",
    },
    "fr_partut": {
        "train": "UD_French-ParTUT/r2.13/fr_partut-ud-train.conllu",
        "dev": "UD_French-ParTUT/r2.13/fr_partut-ud-dev.conllu",
        "test": "UD_French-ParTUT/r2.13/fr_partut-ud-test.conllu",
    },
    "fr_pud": {
        "test": "UD_French-PUD/r2.13/fr_pud-ud-test.conllu",
    },
    "fr_sequoia": {
        "train": "UD_French-Sequoia/r2.13/fr_sequoia-ud-train.conllu",
        "dev": "UD_French-Sequoia/r2.13/fr_sequoia-ud-dev.conllu",
        "test": "UD_French-Sequoia/r2.13/fr_sequoia-ud-test.conllu",
    },
    "fr_spoken": {
        "train": "UD_French-Spoken/r2.13/fr_spoken-ud-train.conllu",
        "dev": "UD_French-Spoken/r2.13/fr_spoken-ud-dev.conllu",
        "test": "UD_French-Spoken/r2.13/fr_spoken-ud-test.conllu",
    },
    "gl_ctg": {
        "train": "UD_Galician-CTG/r2.13/gl_ctg-ud-train.conllu",
        "dev": "UD_Galician-CTG/r2.13/gl_ctg-ud-dev.conllu",
        "test": "UD_Galician-CTG/r2.13/gl_ctg-ud-test.conllu",
    },
    "gl_treegal": {
        "train": "UD_Galician-TreeGal/r2.13/gl_treegal-ud-train.conllu",
        "test": "UD_Galician-TreeGal/r2.13/gl_treegal-ud-test.conllu",
    },
    "de_gsd": {
        "train": "UD_German-GSD/r2.13/de_gsd-ud-train.conllu",
        "dev": "UD_German-GSD/r2.13/de_gsd-ud-dev.conllu",
        "test": "UD_German-GSD/r2.13/de_gsd-ud-test.conllu",
    },
    "de_hdt": {
        "train": [
            "UD_German-HDT/r2.13/de_hdt-ud-train-a-1.conllu",
            "UD_German-HDT/r2.13/de_hdt-ud-train-a-2.conllu",
            "UD_German-HDT/r2.13/de_hdt-ud-train-b-1.conllu",
            "UD_German-HDT/r2.13/de_hdt-ud-train-b-2.conllu",
        ],
        "dev": "UD_German-HDT/r2.13/de_hdt-ud-dev.conllu",
        "test": "UD_German-HDT/r2.13/de_hdt-ud-test.conllu",
    },
    "de_lit": {
        "test": "UD_German-LIT/r2.13/de_lit-ud-test.conllu",
    },
    "de_pud": {
        "test": "UD_German-PUD/r2.13/de_pud-ud-test.conllu",
    },
    "got_proiel": {
        "train": "UD_Gothic-PROIEL/r2.13/got_proiel-ud-train.conllu",
        "dev": "UD_Gothic-PROIEL/r2.13/got_proiel-ud-dev.conllu",
        "test": "UD_Gothic-PROIEL/r2.13/got_proiel-ud-test.conllu",
    },
    "el_gdt": {
        "train": "UD_Greek-GDT/r2.13/el_gdt-ud-train.conllu",
        "dev": "UD_Greek-GDT/r2.13/el_gdt-ud-dev.conllu",
        "test": "UD_Greek-GDT/r2.13/el_gdt-ud-test.conllu",
    },
    "he_htb": {
        "train": "UD_Hebrew-HTB/r2.13/he_htb-ud-train.conllu",
        "dev": "UD_Hebrew-HTB/r2.13/he_htb-ud-dev.conllu",
        "test": "UD_Hebrew-HTB/r2.13/he_htb-ud-test.conllu",
    },
    "qhe_hiencs": {
        "train": "UD_Hindi_English-HIENCS/r2.13/qhe_hiencs-ud-train.conllu",
        "dev": "UD_Hindi_English-HIENCS/r2.13/qhe_hiencs-ud-dev.conllu",
        "test": "UD_Hindi_English-HIENCS/r2.13/qhe_hiencs-ud-test.conllu",
    },
    "hi_hdtb": {
        "train": "UD_Hindi-HDTB/r2.13/hi_hdtb-ud-train.conllu",
        "dev": "UD_Hindi-HDTB/r2.13/hi_hdtb-ud-dev.conllu",
        "test": "UD_Hindi-HDTB/r2.13/hi_hdtb-ud-test.conllu",
    },
    "hi_pud": {
        "test": "UD_Hindi-PUD/r2.13/hi_pud-ud-test.conllu",
    },
    "hu_szeged": {
        "train": "UD_Hungarian-Szeged/r2.13/hu_szeged-ud-train.conllu",
        "dev": "UD_Hungarian-Szeged/r2.13/hu_szeged-ud-dev.conllu",
        "test": "UD_Hungarian-Szeged/r2.13/hu_szeged-ud-test.conllu",
    },
    "is_icepahc": {
        "train": "UD_Icelandic-IcePaHC/r2.13/is_icepahc-ud-train.conllu",
        "dev": "UD_Icelandic-IcePaHC/r2.13/is_icepahc-ud-dev.conllu",
        "test": "UD_Icelandic-IcePaHC/r2.13/is_icepahc-ud-test.conllu",
    },
    "is_pud": {
        "test": "UD_Icelandic-PUD/r2.13/is_pud-ud-test.conllu",
    },
    "id_csui": {
        "train": "UD_Indonesian-CSUI/r2.13/id_csui-ud-train.conllu",
        "test": "UD_Indonesian-CSUI/r2.13/id_csui-ud-test.conllu",
    },
    "id_gsd": {
        "train": "UD_Indonesian-GSD/r2.13/id_gsd-ud-train.conllu",
        "dev": "UD_Indonesian-GSD/r2.13/id_gsd-ud-dev.conllu",
        "test": "UD_Indonesian-GSD/r2.13/id_gsd-ud-test.conllu",
    },
    "id_pud": {
        "test": "UD_Indonesian-PUD/r2.13/id_pud-ud-test.conllu",
    },
    "ga_idt": {
        "train": "UD_Irish-IDT/r2.13/ga_idt-ud-train.conllu",
        "dev": "UD_Irish-IDT/r2.13/ga_idt-ud-dev.conllu",
        "test": "UD_Irish-IDT/r2.13/ga_idt-ud-test.conllu",
    },
    "it_isdt": {
        "train": "UD_Italian-ISDT/r2.13/it_isdt-ud-train.conllu",
        "dev": "UD_Italian-ISDT/r2.13/it_isdt-ud-dev.conllu",
        "test": "UD_Italian-ISDT/r2.13/it_isdt-ud-test.conllu",
    },
    "it_partut": {
        "train": "UD_Italian-ParTUT/r2.13/it_partut-ud-train.conllu",
        "dev": "UD_Italian-ParTUT/r2.13/it_partut-ud-dev.conllu",
        "test": "UD_Italian-ParTUT/r2.13/it_partut-ud-test.conllu",
    },
    "it_postwita": {
        "train": "UD_Italian-PoSTWITA/r2.13/it_postwita-ud-train.conllu",
        "dev": "UD_Italian-PoSTWITA/r2.13/it_postwita-ud-dev.conllu",
        "test": "UD_Italian-PoSTWITA/r2.13/it_postwita-ud-test.conllu",
    },
    "it_pud": {
        "test": "UD_Italian-PUD/r2.13/it_pud-ud-test.conllu",
    },
    "it_twittiro": {
        "train": "UD_Italian-TWITTIRO/r2.13/it_twittiro-ud-train.conllu",
        "dev": "UD_Italian-TWITTIRO/r2.13/it_twittiro-ud-dev.conllu",
        "test": "UD_Italian-TWITTIRO/r2.13/it_twittiro-ud-test.conllu",
    },
    "it_vit": {
        "train": "UD_Italian-VIT/r2.13/it_vit-ud-train.conllu",
        "dev": "UD_Italian-VIT/r2.13/it_vit-ud-dev.conllu",
        "test": "UD_Italian-VIT/r2.13/it_vit-ud-test.conllu",
    },
    "ja_bccwj": {
        "train": "UD_Japanese-BCCWJ/r2.13/ja_bccwj-ud-train.conllu",
        "dev": "UD_Japanese-BCCWJ/r2.13/ja_bccwj-ud-dev.conllu",
        "test": "UD_Japanese-BCCWJ/r2.13/ja_bccwj-ud-test.conllu",
    },
    "ja_gsd": {
        "train": "UD_Japanese-GSD/r2.13/ja_gsd-ud-train.conllu",
        "dev": "UD_Japanese-GSD/r2.13/ja_gsd-ud-dev.conllu",
        "test": "UD_Japanese-GSD/r2.13/ja_gsd-ud-test.conllu",
    },
    "ja_modern": {
        "test": "UD_Japanese-Modern/r2.13/ja_modern-ud-test.conllu",
    },
    "ja_pud": {
        "test": "UD_Japanese-PUD/r2.13/ja_pud-ud-test.conllu",
    },
    "krl_kkpp": {
        "test": "UD_Karelian-KKPP/r2.13/krl_kkpp-ud-test.conllu",
    },
    "kk_ktb": {
        "train": "UD_Kazakh-KTB/r2.13/kk_ktb-ud-train.conllu",
        "test": "UD_Kazakh-KTB/r2.13/kk_ktb-ud-test.conllu",
    },
    "kfm_aha": {
        "test": "UD_Khunsari-AHA/r2.13/kfm_aha-ud-test.conllu",
    },
    "koi_uh": {
        "test": "UD_Komi_Permyak-UH/r2.13/koi_uh-ud-test.conllu",
    },
    "kpv_ikdp": {
        "test": "UD_Komi_Zyrian-IKDP/r2.13/kpv_ikdp-ud-test.conllu",
    },
    "kpv_lattice": {
        "test": "UD_Komi_Zyrian-Lattice/r2.13/kpv_lattice-ud-test.conllu",
    },
    "ko_gsd": {
        "train": "UD_Korean-GSD/r2.13/ko_gsd-ud-train.conllu",
        "dev": "UD_Korean-GSD/r2.13/ko_gsd-ud-dev.conllu",
        "test": "UD_Korean-GSD/r2.13/ko_gsd-ud-test.conllu",
    },
    "ko_kaist": {
        "train": "UD_Korean-Kaist/r2.13/ko_kaist-ud-train.conllu",
        "dev": "UD_Korean-Kaist/r2.13/ko_kaist-ud-dev.conllu",
        "test": "UD_Korean-Kaist/r2.13/ko_kaist-ud-test.conllu",
    },
    "ko_pud": {
        "test": "UD_Korean-PUD/r2.13/ko_pud-ud-test.conllu",
    },
    "kmr_mg": {
        "train": "UD_Kurmanji-MG/r2.13/kmr_mg-ud-train.conllu",
        "test": "UD_Kurmanji-MG/r2.13/kmr_mg-ud-test.conllu",
    },
    "la_ittb": {
        "train": "UD_Latin-ITTB/r2.13/la_ittb-ud-train.conllu",
        "dev": "UD_Latin-ITTB/r2.13/la_ittb-ud-dev.conllu",
        "test": "UD_Latin-ITTB/r2.13/la_ittb-ud-test.conllu",
    },
    "la_llct": {
        "train": "UD_Latin-LLCT/r2.13/la_llct-ud-train.conllu",
        "dev": "UD_Latin-LLCT/r2.13/la_llct-ud-dev.conllu",
        "test": "UD_Latin-LLCT/r2.13/la_llct-ud-test.conllu",
    },
    "la_perseus": {
        "train": "UD_Latin-Perseus/r2.13/la_perseus-ud-train.conllu",
        "test": "UD_Latin-Perseus/r2.13/la_perseus-ud-test.conllu",
    },
    "la_proiel": {
        "train": "UD_Latin-PROIEL/r2.13/la_proiel-ud-train.conllu",
        "dev": "UD_Latin-PROIEL/r2.13/la_proiel-ud-dev.conllu",
        "test": "UD_Latin-PROIEL/r2.13/la_proiel-ud-test.conllu",
    },
    "lij_glt": {
        "train": "UD_Ligurian-GLT/r2.13/lij_glt-ud-train.conllu",
        "test": "UD_Ligurian-GLT/r2.13/lij_glt-ud-test.conllu",
    },
    "lv_lvtb": {
        "train": "UD_Latvian-LVTB/r2.13/lv_lvtb-ud-train.conllu",
        "dev": "UD_Latvian-LVTB/r2.13/lv_lvtb-ud-dev.conllu",
        "test": "UD_Latvian-LVTB/r2.13/lv_lvtb-ud-test.conllu",
    },
    "lt_alksnis": {
        "train": "UD_Lithuanian-ALKSNIS/r2.13/lt_alksnis-ud-train.conllu",
        "dev": "UD_Lithuanian-ALKSNIS/r2.13/lt_alksnis-ud-dev.conllu",
        "test": "UD_Lithuanian-ALKSNIS/r2.13/lt_alksnis-ud-test.conllu",
    },
    "lt_hse": {
        "train": "UD_Lithuanian-HSE/r2.13/lt_hse-ud-train.conllu",
        "dev": "UD_Lithuanian-HSE/r2.13/lt_hse-ud-train.conllu",
        "test": "UD_Lithuanian-HSE/r2.13/lt_hse-ud-train.conllu",
    },
    "olo_kkpp": {
        "train": "UD_Livvi-KKPP/r2.13/olo_kkpp-ud-train.conllu",
        "test": "UD_Livvi-KKPP/r2.13/olo_kkpp-ud-test.conllu",
    },
    "mk_mtb": {
        "test": "UD_Macedonian-MTB/r2.13/mk_mtb-ud-test.conllu",
    },
    "mt_mudt": {
        "train": "UD_Maltese-MUDT/r2.13/mt_mudt-ud-train.conllu",
        "dev": "UD_Maltese-MUDT/r2.13/mt_mudt-ud-dev.conllu",
        "test": "UD_Maltese-MUDT/r2.13/mt_mudt-ud-test.conllu",
    },
    "gv_cadhan": {
        "test": "UD_Manx-Cadhan/r2.13/gv_cadhan-ud-test.conllu",
    },
    "mr_ufal": {
        "train": "UD_Marathi-UFAL/r2.13/mr_ufal-ud-train.conllu",
        "dev": "UD_Marathi-UFAL/r2.13/mr_ufal-ud-dev.conllu",
        "test": "UD_Marathi-UFAL/r2.13/mr_ufal-ud-test.conllu",
    },
    "gun_dooley": {
        "test": "UD_Mbya_Guarani-Dooley/r2.13/gun_dooley-ud-test.conllu",
    },
    "gun_thomas": {
        "test": "UD_Mbya_Guarani-Thomas/r2.13/gun_thomas-ud-test.conllu",
    },
    "mdf_jr": {
        "test": "UD_Moksha-JR/r2.13/mdf_jr-ud-test.conllu",
    },
    "myu_tudet": {
        "test": "UD_Munduruku-TuDeT/r2.13/myu_tudet-ud-test.conllu",
    },
    "pcm_nsc": {
        "train": "UD_Naija-NSC/r2.13/pcm_nsc-ud-train.conllu",
        "dev": "UD_Naija-NSC/r2.13/pcm_nsc-ud-dev.conllu",
        "test": "UD_Naija-NSC/r2.13/pcm_nsc-ud-test.conllu",
    },
    "nyq_aha": {
        "test": "UD_Nayini-AHA/r2.13/nyq_aha-ud-test.conllu",
    },
    "sme_giella": {
        "train": "UD_North_Sami-Giella/r2.13/sme_giella-ud-train.conllu",
        "test": "UD_North_Sami-Giella/r2.13/sme_giella-ud-test.conllu",
    },
    "no_bokmaal": {
        "train": "UD_Norwegian-Bokmaal/r2.13/no_bokmaal-ud-train.conllu",
        "dev": "UD_Norwegian-Bokmaal/r2.13/no_bokmaal-ud-dev.conllu",
        "test": "UD_Norwegian-Bokmaal/r2.13/no_bokmaal-ud-test.conllu",
    },
    "no_nynorsk": {
        "train": "UD_Norwegian-Nynorsk/r2.13/no_nynorsk-ud-train.conllu",
        "dev": "UD_Norwegian-Nynorsk/r2.13/no_nynorsk-ud-dev.conllu",
        "test": "UD_Norwegian-Nynorsk/r2.13/no_nynorsk-ud-test.conllu",
    },
    "no_nynorsklia": {
        "train": "UD_Norwegian-NynorskLIA/r2.13/no_nynorsklia-ud-train.conllu",
        "dev": "UD_Norwegian-NynorskLIA/r2.13/no_nynorsklia-ud-dev.conllu",
        "test": "UD_Norwegian-NynorskLIA/r2.13/no_nynorsklia-ud-test.conllu",
    },
    "cu_proiel": {
        "train": "UD_Old_Church_Slavonic-PROIEL/r2.13/cu_proiel-ud-train.conllu",
        "dev": "UD_Old_Church_Slavonic-PROIEL/r2.13/cu_proiel-ud-dev.conllu",
        "test": "UD_Old_Church_Slavonic-PROIEL/r2.13/cu_proiel-ud-test.conllu",
    },
    "fro_srcmf": {
        "train": "UD_Old_French-SRCMF/r2.13/fro_srcmf-ud-train.conllu",
        "dev": "UD_Old_French-SRCMF/r2.13/fro_srcmf-ud-dev.conllu",
        "test": "UD_Old_French-SRCMF/r2.13/fro_srcmf-ud-test.conllu",
    },
    "orv_rnc": {
        "train": "UD_Old_Russian-RNC/r2.13/orv_rnc-ud-train.conllu",
        "test": "UD_Old_Russian-RNC/r2.13/orv_rnc-ud-test.conllu",
    },
    "orv_torot": {
        "train": "UD_Old_Russian-TOROT/r2.13/orv_torot-ud-train.conllu",
        "dev": "UD_Old_Russian-TOROT/r2.13/orv_torot-ud-dev.conllu",
        "test": "UD_Old_Russian-TOROT/r2.13/orv_torot-ud-test.conllu",
    },
    "otk_tonqq": {
        "test": "UD_Old_Turkish-Tonqq/r2.13/otk_tonqq-ud-test.conllu",
    },
    "fa_perdt": {
        "train": "UD_Persian-PerDT/r2.13/fa_perdt-ud-train.conllu",
        "dev": "UD_Persian-PerDT/r2.13/fa_perdt-ud-dev.conllu",
        "test": "UD_Persian-PerDT/r2.13/fa_perdt-ud-test.conllu",
    },
    "fa_seraji": {
        "train": "UD_Persian-Seraji/r2.13/fa_seraji-ud-train.conllu",
        "dev": "UD_Persian-Seraji/r2.13/fa_seraji-ud-dev.conllu",
        "test": "UD_Persian-Seraji/r2.13/fa_seraji-ud-test.conllu",
    },
    "pl_lfg": {
        "train": "UD_Polish-LFG/r2.13/pl_lfg-ud-train.conllu",
        "dev": "UD_Polish-LFG/r2.13/pl_lfg-ud-dev.conllu",
        "test": "UD_Polish-LFG/r2.13/pl_lfg-ud-test.conllu",
    },
    "pl_pdb": {
        "train": "UD_Polish-PDB/r2.13/pl_pdb-ud-train.conllu",
        "dev": "UD_Polish-PDB/r2.13/pl_pdb-ud-dev.conllu",
        "test": "UD_Polish-PDB/r2.13/pl_pdb-ud-test.conllu",
    },
    "pl_pud": {
        "test": "UD_Polish-PUD/r2.13/pl_pud-ud-test.conllu",
    },
    "pt_bosque": {
        "train": "UD_Portuguese-Bosque/r2.13/pt_bosque-ud-train.conllu",
        "dev": "UD_Portuguese-Bosque/r2.13/pt_bosque-ud-dev.conllu",
        "test": "UD_Portuguese-Bosque/r2.13/pt_bosque-ud-test.conllu",
    },
    "pt_gsd": {
        "train": "UD_Portuguese-GSD/r2.13/pt_gsd-ud-train.conllu",
        "dev": "UD_Portuguese-GSD/r2.13/pt_gsd-ud-dev.conllu",
        "test": "UD_Portuguese-GSD/r2.13/pt_gsd-ud-test.conllu",
    },
    "pt_pud": {
        "test": "UD_Portuguese-PUD/r2.13/pt_pud-ud-test.conllu",
    },
    "ro_nonstandard": {
        "train": "UD_Romanian-Nonstandard/r2.13/ro_nonstandard-ud-train.conllu",
        "dev": "UD_Romanian-Nonstandard/r2.13/ro_nonstandard-ud-dev.conllu",
        "test": "UD_Romanian-Nonstandard/r2.13/ro_nonstandard-ud-test.conllu",
    },
    "ro_rrt": {
        "train": "UD_Romanian-RRT/r2.13/ro_rrt-ud-train.conllu",
        "dev": "UD_Romanian-RRT/r2.13/ro_rrt-ud-dev.conllu",
        "test": "UD_Romanian-RRT/r2.13/ro_rrt-ud-test.conllu",
    },
    "ro_simonero": {
        "train": "UD_Romanian-SiMoNERo/r2.13/ro_simonero-ud-train.conllu",
        "dev": "UD_Romanian-SiMoNERo/r2.13/ro_simonero-ud-dev.conllu",
        "test": "UD_Romanian-SiMoNERo/r2.13/ro_simonero-ud-test.conllu",
    },
    "ru_gsd": {
        "train": "UD_Russian-GSD/r2.13/ru_gsd-ud-train.conllu",
        "dev": "UD_Russian-GSD/r2.13/ru_gsd-ud-dev.conllu",
        "test": "UD_Russian-GSD/r2.13/ru_gsd-ud-test.conllu",
    },
    "ru_pud": {
        "test": "UD_Russian-PUD/r2.13/ru_pud-ud-test.conllu",
    },
    "ru_syntagrus": {
        "train": "UD_Russian-SynTagRus/r2.13/ru_syntagrus-ud-train.conllu",
        "dev": "UD_Russian-SynTagRus/r2.13/ru_syntagrus-ud-dev.conllu",
        "test": "UD_Russian-SynTagRus/r2.13/ru_syntagrus-ud-test.conllu",
    },
    "ru_taiga": {
        "train": "UD_Russian-Taiga/r2.13/ru_taiga-ud-train.conllu",
        "dev": "UD_Russian-Taiga/r2.13/ru_taiga-ud-dev.conllu",
        "test": "UD_Russian-Taiga/r2.13/ru_taiga-ud-test.conllu",
    },
    "sa_ufal": {
        "test": "UD_Sanskrit-UFAL/r2.13/sa_ufal-ud-test.conllu",
    },
    "sa_vedic": {
        "train": "UD_Sanskrit-Vedic/r2.13/sa_vedic-ud-train.conllu",
        "test": "UD_Sanskrit-Vedic/r2.13/sa_vedic-ud-test.conllu",
    },
    "sd_mazhardootio": {
        "test": "UD_Sindhi-MazharDootio/dev/sd_mazhardootio-ud-test.conllu",
    },
    "si_stb": {
        "test": "UD_Sinhala-STB/r2.13/si_stb-ud-test.conllu",
    },
    "gd_arcosg": {
        "train": "UD_Scottish_Gaelic-ARCOSG/r2.13/gd_arcosg-ud-train.conllu",
        "dev": "UD_Scottish_Gaelic-ARCOSG/r2.13/gd_arcosg-ud-dev.conllu",
        "test": "UD_Scottish_Gaelic-ARCOSG/r2.13/gd_arcosg-ud-test.conllu",
    },
    "sr_set": {
        "train": "UD_Serbian-SET/r2.13/sr_set-ud-train.conllu",
        "dev": "UD_Serbian-SET/r2.13/sr_set-ud-dev.conllu",
        "test": "UD_Serbian-SET/r2.13/sr_set-ud-test.conllu",
    },
    "sms_giellagas": {
        "test": "UD_Skolt_Sami-Giellagas/r2.13/sms_giellagas-ud-test.conllu",
    },
    "sk_snk": {
        "train": "UD_Slovak-SNK/r2.13/sk_snk-ud-train.conllu",
        "dev": "UD_Slovak-SNK/r2.13/sk_snk-ud-dev.conllu",
        "test": "UD_Slovak-SNK/r2.13/sk_snk-ud-test.conllu",
    },
    "sl_ssj": {
        "train": "UD_Slovenian-SSJ/r2.13/sl_ssj-ud-train.conllu",
        "dev": "UD_Slovenian-SSJ/r2.13/sl_ssj-ud-dev.conllu",
        "test": "UD_Slovenian-SSJ/r2.13/sl_ssj-ud-test.conllu",
    },
    "sl_sst": {
        "train": "UD_Slovenian-SST/r2.13/sl_sst-ud-train.conllu",
        "test": "UD_Slovenian-SST/r2.13/sl_sst-ud-test.conllu",
    },
    "soj_aha": {
        "test": "UD_Soi-AHA/r2.13/soj_aha-ud-test.conllu",
    },
    "ajp_madar": {
        "test": "UD_South_Levantine_Arabic-MADAR/r2.13/ajp_madar-ud-test.conllu",
    },
    "es_ancora": {
        "train": "UD_Spanish-AnCora/r2.13/es_ancora-ud-train.conllu",
        "dev": "UD_Spanish-AnCora/r2.13/es_ancora-ud-dev.conllu",
        "test": "UD_Spanish-AnCora/r2.13/es_ancora-ud-test.conllu",
    },
    "es_gsd": {
        "train": "UD_Spanish-GSD/r2.13/es_gsd-ud-train.conllu",
        "dev": "UD_Spanish-GSD/r2.13/es_gsd-ud-dev.conllu",
        "test": "UD_Spanish-GSD/r2.13/es_gsd-ud-test.conllu",
    },
    "es_pud": {
        "test": "UD_Spanish-PUD/r2.13/es_pud-ud-test.conllu",
    },
    "swl_sslc": {
        "train": "UD_Swedish_Sign_Language-SSLC/r2.13/swl_sslc-ud-train.conllu",
        "dev": "UD_Swedish_Sign_Language-SSLC/r2.13/swl_sslc-ud-dev.conllu",
        "test": "UD_Swedish_Sign_Language-SSLC/r2.13/swl_sslc-ud-test.conllu",
    },
    "sv_lines": {
        "train": "UD_Swedish-LinES/r2.13/sv_lines-ud-train.conllu",
        "dev": "UD_Swedish-LinES/r2.13/sv_lines-ud-dev.conllu",
        "test": "UD_Swedish-LinES/r2.13/sv_lines-ud-test.conllu",
    },
    "sv_pud": {
        "test": "UD_Swedish-PUD/r2.13/sv_pud-ud-test.conllu",
    },
    "sv_talbanken": {
        "train": "UD_Swedish-Talbanken/r2.13/sv_talbanken-ud-train.conllu",
        "dev": "UD_Swedish-Talbanken/r2.13/sv_talbanken-ud-dev.conllu",
        "test": "UD_Swedish-Talbanken/r2.13/sv_talbanken-ud-test.conllu",
    },
    "gsw_uzh": {
        "test": "UD_Swiss_German-UZH/r2.13/gsw_uzh-ud-test.conllu",
    },
    "tl_trg": {
        "test": "UD_Tagalog-TRG/r2.13/tl_trg-ud-test.conllu",
    },
    "tl_ugnayan": {
        "test": "UD_Tagalog-Ugnayan/r2.13/tl_ugnayan-ud-test.conllu",
    },
    "ta_mwtt": {
        "test": "UD_Tamil-MWTT/r2.13/ta_mwtt-ud-test.conllu",
    },
    "ta_ttb": {
        "train": "UD_Tamil-TTB/r2.13/ta_ttb-ud-train.conllu",
        "dev": "UD_Tamil-TTB/r2.13/ta_ttb-ud-dev.conllu",
        "test": "UD_Tamil-TTB/r2.13/ta_ttb-ud-test.conllu",
    },
    "te_mtg": {
        "train": "UD_Telugu-MTG/r2.13/te_mtg-ud-train.conllu",
        "dev": "UD_Telugu-MTG/r2.13/te_mtg-ud-dev.conllu",
        "test": "UD_Telugu-MTG/r2.13/te_mtg-ud-test.conllu",
    },
    "th_pud": {
        "test": "UD_Thai-PUD/r2.13/th_pud-ud-test.conllu",
    },
    "tpn_tudet": {
        "test": "UD_Tupinamba-TuDeT/r2.13/tpn_tudet-ud-test.conllu",
    },
    "tt_nmctt": {
        "test": "UD_Tatar-NMCTT/r2.13/tt_nmctt-ud-test.conllu",
    },
    "qtd_sagt": {
        "train": "UD_Turkish_German-SAGT/r2.13/qtd_sagt-ud-train.conllu",
        "dev": "UD_Turkish_German-SAGT/r2.13/qtd_sagt-ud-dev.conllu",
        "test": "UD_Turkish_German-SAGT/r2.13/qtd_sagt-ud-test.conllu",
    },
    "tr_boun": {
        "train": "UD_Turkish-BOUN/r2.13/tr_boun-ud-train.conllu",
        "dev": "UD_Turkish-BOUN/r2.13/tr_boun-ud-dev.conllu",
        "test": "UD_Turkish-BOUN/r2.13/tr_boun-ud-test.conllu",
    },
    "tr_gb": {
        "test": "UD_Turkish-GB/r2.13/tr_gb-ud-test.conllu",
    },
    "tr_imst": {
        "train": "UD_Turkish-IMST/r2.13/tr_imst-ud-train.conllu",
        "dev": "UD_Turkish-IMST/r2.13/tr_imst-ud-dev.conllu",
        "test": "UD_Turkish-IMST/r2.13/tr_imst-ud-test.conllu",
    },
    "tr_pud": {
        "test": "UD_Turkish-PUD/r2.13/tr_pud-ud-test.conllu",
    },
    "uk_iu": {
        "train": "UD_Ukrainian-IU/r2.13/uk_iu-ud-train.conllu",
        "dev": "UD_Ukrainian-IU/r2.13/uk_iu-ud-dev.conllu",
        "test": "UD_Ukrainian-IU/r2.13/uk_iu-ud-test.conllu",
    },
    "hsb_ufal": {
        "train": "UD_Upper_Sorbian-UFAL/r2.13/hsb_ufal-ud-train.conllu",
        "test": "UD_Upper_Sorbian-UFAL/r2.13/hsb_ufal-ud-test.conllu",
    },
    "ur_udtb": {
        "train": "UD_Urdu-UDTB/r2.13/ur_udtb-ud-train.conllu",
        "dev": "UD_Urdu-UDTB/r2.13/ur_udtb-ud-dev.conllu",
        "test": "UD_Urdu-UDTB/r2.13/ur_udtb-ud-test.conllu",
    },
    "ug_udt": {
        "train": "UD_Uyghur-UDT/r2.13/ug_udt-ud-train.conllu",
        "dev": "UD_Uyghur-UDT/r2.13/ug_udt-ud-dev.conllu",
        "test": "UD_Uyghur-UDT/r2.13/ug_udt-ud-test.conllu",
    },
    "vi_vtb": {
        "train": "UD_Vietnamese-VTB/r2.13/vi_vtb-ud-train.conllu",
        "dev": "UD_Vietnamese-VTB/r2.13/vi_vtb-ud-dev.conllu",
        "test": "UD_Vietnamese-VTB/r2.13/vi_vtb-ud-test.conllu",
    },
    "wbp_ufal": {
        "test": "UD_Warlpiri-UFAL/r2.13/wbp_ufal-ud-test.conllu",
    },
    "cy_ccg": {
        "train": "UD_Welsh-CCG/r2.13/cy_ccg-ud-train.conllu",
        "test": "UD_Welsh-CCG/r2.13/cy_ccg-ud-test.conllu",
    },
    "wo_wtb": {
        "train": "UD_Wolof-WTB/r2.13/wo_wtb-ud-train.conllu",
        "dev": "UD_Wolof-WTB/r2.13/wo_wtb-ud-dev.conllu",
        "test": "UD_Wolof-WTB/r2.13/wo_wtb-ud-test.conllu",
    },
    "yo_ytb": {
        "test": "UD_Yoruba-YTB/r2.13/yo_ytb-ud-test.conllu",
    },
}
...
class UniversaldependenciesConfig(datasets.BuilderConfig):
    ...
    def __init__(self, data_url, **kwargs):
        super(UniversaldependenciesConfig, self).__init__(version=datasets.Version("2.13.0", ""), **kwargs)

        self.data_url = data_url


class UniversalDependencies(datasets.GeneratorBasedBuilder):
    VERSION = datasets.Version("2.13.0")
    BUILDER_CONFIGS = [
